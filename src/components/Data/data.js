...
export const options2 = [
  { value: "Signature", label: "Signature", Id: 1, title:"2000 AED" },
  { value: "Premium", label: "Premium", Id: 1, title:"2750 AED" },
  { value: "Deluxe", label: "Deluxe", Id: 1, title:"3500 AED" },
  { value: "Custom", label: "Custom", Id: 1 },
  { value: "Individual", label: "Individual", Id: 1 },
  { value: "Signature", label: "Signature", Id: 2, title:"2000 AED" },
  { value: "Premium", label: "Premium", Id: 2, title:"2750 AED" },
  { value: "Deluxe", label: "Deluxe", Id: 2, title:"3500 AED" },
  { value: "Custom", label: "Custom", Id: 2 },
  { value: "Individual", label: "Individual", Id: 2 },
  { value: "Signature", label: "Signature", Id: 3, title:"2000 AED" },
  { value: "Premium", label: "Premium", Id: 3, title:"2750 AED" },
  { value: "Deluxe", label: "Deluxe", Id: 3,title:"3500 AED"  },
  { value: "Custom", label: "Custom", Id: 3 },
  { value: "Individual", label: "Individual", Id: 3 },
  { value: "Signature", label: "Signature", Id: 4 , title:"2000 AED"},
  { value: "Premium", label: "Premium", Id: 4, title:"2750 AED" },
  { value: "Deluxe", label: "Deluxe", Id: 4, title:"3500 AED"  },
  { value: "Custom", label: "Custom", Id: 4 },
  { value: "Individual", label: "Individual", Id: 4 },
  { value: "Signature", label: "Signature", Id: 5,title:"2000 AED" },
  { value: "Premium", label: "Premium", Id: 5,title:"2750 AED" },
  { value: "Deluxe", label: "Deluxe", Id: 5,title:"3500 AED"  },
  { value: "Custom", label: "Custom", Id: 5 },
  { value: "Individual", label: "Individual", Id: 5 },
  { value: "Signature", label: "Signature", Id: 6,title:"2000 AED" },
  { value: "Premium", label: "Premium", Id: 6, title:"2750 AED"  },
  { value: "Deluxe", label: "Deluxe", Id: 6, title:"3500 AED"  },
  { value: "Custom", label: "Custom", Id: 6 },
  { value: "Individual", label: "Individual", Id: 6 },
];

export const ModalItem = [
  { title: "Backdrop", subtitle: "1300 AED " },
  { title: "Welcome board", subtitle: "350 AED" },
  { title: "Digital invitation", subtitle: "150 AED" },
  { title: "Podium (up to 3)", subtitle: "400 AED" },
  { title: "Balloon arch", subtitle: "600 AED" },
  { title: "Balloon column (2)", subtitle: "450 AED" },
  { title: "Light up signage", subtitle: "250 AED" },
  { title: "Themed prop", subtitle: "400 AED" },
  { title: "Personalised sticker", subtitle: "200 AED" },
  { title: "Light up letter or number", subtitle: "400 AED" },
];
