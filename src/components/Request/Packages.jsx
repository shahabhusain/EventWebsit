                ...
                {pkg.features.map((feature, i) => (
                  <div key={i}>
                    <input
                      ...
                      checked
                    />
                    <label htmlFor={`${pkg.name.toLowerCase()}-feature-${i}`}>
                      {" "}
                      {feature}
                    </label>
                    <br />
          ...
          >
            <div className=" py-8 flex flex-col gap-4">
              ...
              <div className=" flex items-center gap-2 bg-[#161C27] py-1 px-3 rounded-md">
                ...
                />
                <button className=" bg-[#FFEDA4] py-2.5 w-full rounded-md text-black">
                  Add
                </button>
              </div>
              <div>
                <div className=" flex items-center gap-3 w-full mt-6">
                  ...
                  <button className=" py-3 px-6 rounded-md bg-[#FFEDA4] w-full text-black">
                    Save Changes
                  </button>
                </div>
              </div>
